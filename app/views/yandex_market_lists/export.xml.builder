    ...
    xml.offers do
      @products.each do |product|
        ...
        xml.offer(params) do
          ...
          xml.picture     image_url product.photos.first.file.url(:product)

          xml.categoryId  product.product_category.id
          xml.currencyId  'RUR'
          ...
          # xml.vendorCode '???'
          # xml.description Sanitize.total('bla bla')[0...175]
          ...
          # Заводская гарантия?
          # xml.manufacturer_warranty false
